...
from stateapi.models import State, LocalGovernment

class Command(BaseCommand):
    help = 'Populate database with Nigerian states and LGAs'
    ...
    def handle(self, *args, **options):
        data = {
            ...
            'Kaduna': ['Birni Gwari', 'Chikun', 'Giwa', 'Igabi', 'Ikara', 'Jaba', 'Jema a', 'Kachia', 'Kaduna North', 'Kaduna South', 'Kagarko', 'Kajuru', 'Kaura', 'Kauru', 'Kubau', 'Kudan', 'Lere', 'Makarfi', 'Sabon Gari', 'Sanga', 'Soba', 'Zangon Kataf', 'Zaria'],
            ...
            'Rivers': ['Abua Odual', 'Ahoada East', 'Ahoada West', 'Akuku Toru', 'Andoni', 'Asari Toru', 'Bonny', 'Degema', 'Eleme', 'Emuoha', 'Etche', 'Gokana', 'Ikwerre', 'Khana', 'Obio Akpor', 'Ogba Egbema Ndoni', 'Ogu Bolo', 'Okrika', 'Omumma', 'Opobo Nkoro', 'Oyigbo', 'Port Harcourt', 'Tai'],
        ...
        self.stdout.write(self.style.SUCCESS('Successfully populated states and LGAs'))